...
const zipCodeCheck = 85205

if (canWeDeliver(zipCodeCheck)) {
    console.log("You're in our delivery zone!")
} else {
    console.log("You're not in our delivery zone")
} 
...
const canWeDeliverTwo = (zipCode) => {
    for (let i=0; i < deliveryAreaZipCodes.length; i++) {
        if (zipCode === deliveryAreaZipCodes.length[i]) {
            return true;
        }
    }
...
const zipCodeCheck = 80424;
if (canWeDeliverTwo (zipCodeCheck)) {
    console.log("You're in our delivery zone!")
} else {
    console.log("You're not in our delivery zone")
}
